  ...
  <div style="margin-top:-30px">
    ...
    <div class="contentDiv">
      <div class="pad_top_8">
        ...
        <pagination v-if="totalPage>10" :total="totalPage" :page.sync="page" :limit.sync="pageSize" @pagination="getSearchContainer" />
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async getDepotList() {
      ...
      this.selectedVal = this.depotList[0].code
      this.getSearchContainer() //获取仓库查询table
    },
    // 仓库查询
    async getDeport_v2() {
